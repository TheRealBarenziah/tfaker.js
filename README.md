...
### Zero dependencies & vanilla-flavored !
### Compatibility:
- Node >= 0.10.48
...
- [placekitten.com][3] for the awesome service: these methods are relying on their servers. Click 'em
